function liquidFillGaugeDefaultSettings(){
    return {
        ...
        circleFillGap: 0.04, // The size of the gap between the outer circle and wave circle as a percentage of the outer circles radius.
...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    var percentText = config.units?config.units:percentText;
